...
import { FormControl, FormLabel, Button, Input, Select, useToast } from "@chakra-ui/react";
...
const AdminSideAddProducts = () => {
    ...
    const [productState, setProductState] = useReducer(productReducer, initialProductState);
    ...
    return (
        <div className="AdminSideProductAddContainer">
            <div className="admin_side_update_form_heading">Wondermart Add Product Page</div>
                        ...
                        <FormControl style={{
                            ...
                            <div className="productAddBox1">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setProductState({ type: 'ImgSrc', payload: e.target.value })}
                                />
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setProductState({ type: 'sasta', payload: e.target.value })}
                                />
                                ...
                                <Input
                                    ...
                                    type="text"
                                    onChange={(e) => setProductState({ type: 'weight', payload: e.target.value })}
                                />
                                ...
                                <Input
                                    ...
                                    type={Number}
                                    onChange={(e) => setProductState({ type: 'price', payload: Number(e.target.value) })}
                                />
                                ...
                                <Input
                                    ...
                                    type={Number}
                                    onChange={(e) => setProductState({ type: 'mrp', payload: Number(e.target.value) })}
                                />
                                ...
                                <Input
                                    ...
                                    type="text"
                                    onChange={(e) => setProductState({ type: 'offers', payload: e.target.value })}
                                />
                                ...
                                <Input
                                    ...
                                    type="text"
                                    onChange={(e) => setProductState({ type: 'packet', payload: e.target.value })}
                                />
                            </div>
                            ...
                            <div className="productAddBox2">
                                ...
                                <Select
                                    ...
                                    onChange={(e) => setProductState({ type: 'brand', payload: e.target.value })}
                                >
                                ...
                                <Select
                                    ...
                                    onChange={(e) => setProductState({ type: 'isavailable', payload: e.target.value == "true" ? true : false })}
                                >
                                ...
                                <Select
                                    ...
                                    type={Number}
                                    onChange={(e) => setProductState({ type: 'quantity', payload: Number(e.target.value) })}
                                >
                                ...
                                <Button style={{ margin: "1%", marginTop: "5%" }} colorScheme='pink' onClick={addProductHandler}>Add Product</Button>
