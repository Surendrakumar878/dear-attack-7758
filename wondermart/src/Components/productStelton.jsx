    ...
    <div className="p-2 border shadow-lg hover:shadow-2xl">
        ...
        <div className="flex flex-row gap-3 md:block">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-gray-600 cursor-pointer mt-2">{name}</p>
        ...
        <div className="bg-gray-100 py-2">
            <div className="px-2">
                ...
                <div className="text-[11px] flex items-center gap-2">
                    <div className=""> <img className="w-[25px] h-[20px] cursor-pointer text-green-400" src="https://www.bbassets.com/static/v2627/custPage/build/content/img/express-del-gray.svg" alt="" /></div>
                    <div><p className="cursor-pointer">Express Delivery: <span className="text-red-600">Out of stock</span></p> </div>
                </div>
            </div>
            ...
            <div className="mt-2 px-2 flex items-center gap-3">
                <div className="flex gap-1 items-center text-sm">
                    <button disabled={count<=1} onClick={()=>setCount(count-1)} className="border bg-gray-400 px-1 text-[16px]"><ChevronLeftIcon  /> </button>
                    <h1 className="border bg-white px-3 py-1">{count}</h1>
                    <button disabled={count>=10} onClick={()=>setCount(count+1)} className="border bg-gray-400 px-1 text-[16px]"><ChevronRightIcon/></button>
                </div>
                <div className="flex gap-1 items-center border px-[10px] rounded-md py-1 bg-yellow-300 hover:bg-yellow-400 cursor-pointer text-gray-600">
                    <h1 className="text-xs font-semibold">ADD</h1>
                    <h1 className="text-lg"><GiShoppingCart/></h1>
                </div>
            </div>
        </div>
