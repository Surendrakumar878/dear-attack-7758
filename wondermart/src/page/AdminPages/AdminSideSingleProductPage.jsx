        ...
        <div>
            <div className="admin_side_product_item">
                <div className="product_img_box">
                    ...
                    <div>
                        {isavailable ? <div className="blue availableContainer"><strong>Available</strong></div> : <div className="red availableContainer"><strong>Not Available</strong></div>}
                    </div>
                </div>
                <div className="products_second_box">
                    ...
                    <div className="product_bottom_section">
                        ...
                        <div className="red">
                            <DeleteIcon onClick={() => adminProductDeleteHandler(id)} fontSize="130%" cursor="pointer" />
                        </div>
                    </div>
                </div>
            </div>
